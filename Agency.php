            ...
            <aside class="bg-black h-[100vh] w-[320px] p-5 relative">
                ...
                <ul class="p-5 mt-10">
                    ...
                    <li class="my-2">
                        <a
                            href="bank.html"
                            class="text-lg font-medium block w-[full] rounded-md h-[60px] flex text-white items-center p-5 group hover:text-gray-600"
                        >
                            <i
                                class="fa-solid fa-building-columns mr-5 text-lg group-hover:text-gray-500"
                            ></i
                            >Bank</a
                        >
                    </li>
                    <li class="my-2">
                        <a
                            href="Users.html"
                            class="text-lg font-medium block w-[full] rounded-md h-[60px] text-white flex items-center p-5 group hover:text-gray-500"
                        >
                            <i
                                class="fa-solid fa-user mr-5 text-lg group-hover:text-gray-500"
                            ></i
                            >Users</a
                        >
                    </li>
                    <li class="my-2">
                        ...
                        >
                            <i
                                class="fa-solid fa-file mr-5 text-lg group-hover:text-gray-500"
                            ></i
                            >Accounts</a
                        >
                    </li>
                    <li class="my-2">
                        <a
                            ...
                            class="font-medium block w-[full] rounded-md h-[60px] text-white flex items-center p-5 group hover:text-gray-500"
                        >
                            <i class="fa-solid"></i>
                            <i
                                class="fa-solid fa-right-left mr-5 text-lg group-hover:text-gray-500"
                            ></i
                            >Transactions</a
                        >
                    </li>
                    <li class="my-2">
                        <a
                            href="#"
                            class="active text-lg font-medium block w-[full] rounded-md h-[60px] text-white flex items-center p-5 group hover:text-gray-500"
                        >
                            <i
                                class="fa-solid fa-building mr-5 text-lg group-hover:text-gray-500"
                            ></i>
                            Agency</a
                        >
                    </li>
                    <li class="my-2">
                        <a
                            ...
                            class="text-lf font-medium block w-[full] rounded-md h-[60px] text-white flex items-center p-5 group hover:text-gray-500 bg-gray-900 bg-opacity-20"
                        >
                            <i
                                class="fa-solid fa-credit-card text-white mr-5 text-lg group-hover:text-gray-500"
                            ></i>
                            Distributer</a
                        >
                    </li>
