      ...
      <aside class="bg-black h-[100vh] w-[320px] p-5 relative">
        ...
        <ul class="p-5 mt-10">
          ...
          <li class="my-2">
            <a
              href="bank.php"
              class="text-lg font-medium block w-[full] rounded-md h-[60px] flex items-center text-white p-5 group hover:text-gray-500"
            >
              <i
          ...
          <li class="my-2">
            <a
              href="Users.php"
              class="active text-lg font-medium block w-[full] rounded-md h-[60px] text-white flex items-center p-5 group hover:text-gray-500 bg-gray-900 bg-opacity-20"
            >
              <i
          ...
          <li class="my-2">
            <a
              href="Accounts.html"
              class="text-lg font-medium block w-[full] rounded-md h-[60px] text-white flex items-center p-5 group hover:text-gray-500 bg-gray-900 bg-opacity-20"
            >
              <i
          ...
          <li class="my-2">
            ...
            >
              <i
                class="fa-solid fa-building text-white mr-5 text-lg group-hover:text-gray-500"
              ></i>
              Agnecy</a
            >
          </li>
